                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    ...
                                                    <asp:Repeater ID="rOrderStatus" runat="server" OnItemCommand="rOrderStatus_ItemCommand">
                                                        <HeaderTemplate>
                                                            <table class="table data-table-export table-hovor nowrap">
                                                                <thead>
                                                                    <tr>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        <asp:RequiredFieldValidator ID="rfvDdlOrderStatus" runat="server" Forecolor="Red" ControlToValidate="ddlOrderStatus"
                                                            ErrorMessage="Order status id required" SetFocusOnError="true" Display="Dynamic" InitialValue="0"></asp:RequiredFieldValidator>
