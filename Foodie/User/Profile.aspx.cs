    ...
    public partial class Profile : System.Web.UI.Page
    {
        ...
        void getPurchaseHistory()
        {
            ...
            if (dt.Rows.Count == 0)
            {
                ...
                rPurchaseHistory.FooterTemplate = new CustomTemplete(ListItemType.Footer);
            }
        ...
        // Custom templete class to add controls to the repeater's header, item and footer section.
        private sealed class CustomTemplete : ITemplate
        {
            ...
            public void InstantiateIn(Control container)
            {
                ...
                {
                    var footer = new LiteralControl("<tr><td colspan='5'><b>Hungry! Why not order food for you.</b><a href='Menu.aspx' class='badge badge-info ml-2'>Click to order</a></td></tr></tbody></table>");
